...
Page({
    ...
    //   appId: 'wx31b43acf6e51cff0', extraData: {
    //     apSsid: 'myapssid', apPassword: 'myappassword', hideApInfoInputs: true, guide: { android: ["android步骤1", "android步骤2", "android步骤3"], ios: ["ios步骤A", "ios步骤B", "ios步骤C"] }, userData: null
